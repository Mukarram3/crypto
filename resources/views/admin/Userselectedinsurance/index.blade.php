        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Choose Insurance for User</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" id="addinsurance" action="{{route('SelectedInsurancestore')}}">
                        @csrf
                            ...
                            <div class="form-group">
                                <label for="status">Insurance</label>
                                <select name="insuranceid" class="form-control">
                                    <option value="0">Please Select Insurance</option>
    ...
    <div class="modal fade" id="exampleModaledituser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('SelectedInsuranceUpdate')}}" id="editbalanceform">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="status">Insurance</label>
                                <select name="insuranceid" id="insuranceid" class="form-control">
                                    <option value="0">Please Select Insurance</option>
                                    @foreach($insurances as $insurance)
                                        <option value="{{$insurance->id}}">{{$insurance->name}}</option>
                                    @endforeach
        ...
        <div class="row">
            <a data-toggle="modal" data-target="#exampleModaladduser" class="btn btn-primary font-weight-bolder" style="float: left;">
											<span class="svg-icon svg-icon-md">
                                                ...
                                                <!--end::Svg Icon-->
											</span>Add New User Insurance</a>
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">User Balance</h6>
                    </div>
                    <div class="table-responsive p-3">
                        <table class="table align-items-center responsive" id="dataTable">
                            ...
                            <tr>
                                  <th>ID</th>
                                <th>User Name</th>
                                <th>Selected Insurance</th>
                                <th>Insurance Percentage Increment</th>
                                <th>Action</th>
                            </tr>
                            </thead>
                            <tfoot>
                            ...
                            <tbody>
                            @foreach ($usersinsurances as $usersinsurance)


                                <tr>
                                    <td>{{$usersinsurance->id}}</td>
                                    <td>{{$usersinsurance->hasusers->name}}</td>
                                    <td>{{$usersinsurance->hasinsurance->name}}</td>
                                    <td>{{$usersinsurance->hasinsurance->percent}}</td>
                                    <td> <a type="button" class="editbalance" data-id="{{$usersinsurance->id}}" data-toggle="modal" data-target="#exampleModaledituser"><span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Design\Edit.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
@endif
    ...
    <script>
        ...
        $('.editbalance').on('click', function () {
            ...
            var urll = "{{url('Admin/SelectedInsurance/Edit/')}}/" + edit_id;
