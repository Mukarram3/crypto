    ...
    <script>
        ...
        $spin.on('click',function(){
            ...
            if (i<3){
                ...
                if (numbers.includes(Number(num1)) || numbers.includes(Number(num2))){
                    ...
                    $spin.hide();
                            ...
                            $.get(urll,function (data){
                                toastr.success('1 Bet price Successfully Deducted because Atleast two numbers not matched. Please Start new Game');
                            });
                }
            ...
            toastr.success('Please enter minimum $25 to play...');
        }
